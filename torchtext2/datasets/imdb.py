...
from torchtext2.data.datasets_utils import _create_dataset_directory
from torchtext2.data.datasets_utils import _wrap_split_argument
...
def IMDB(root: str, split: Union[Tuple[str], str]):
    ...
    Args:
        root: Directory where the datasets are saved. Default: os.path.expanduser('~/.torchtext2/cache')

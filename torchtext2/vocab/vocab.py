...
from torchtext2.utils import _log_class_usage
...
class Vocab(nn.Module):
    ...
    Args:
        vocab (torch.classes.torchtext2.Vocab or torchtext2._torchtext2.Vocab): a cpp vocab object.
    """
    ...
    def __prepare_scriptable__(self):
        ...
        if not self.is_jitable:
            cpp_vocab = torch.classes.torchtext2.Vocab(self.vocab.itos_, self.vocab.default_index_)

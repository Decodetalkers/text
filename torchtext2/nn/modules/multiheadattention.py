...
class MultiheadAttentionContainer(torch.nn.Module):
    def __init__(self, nhead, in_proj_container, attention_layer, out_proj, batch_first=False) -> None:
        ...
        Examples::
            >>> import torch
            >>> from torchtext2.nn import MultiheadAttentionContainer, InProjContainer, ScaledDotProduct
...
class ScaledDotProduct(torch.nn.Module):
    def __init__(self, dropout=0.0, batch_first=False) -> None:
        ...
        Examples::
            ...
            >>> SDP = torchtext2.nn.ScaledDotProduct(dropout=0.1)
...
class InProjContainer(torch.nn.Module):
    def __init__(self, query_proj, key_proj, value_proj) -> None:
        ...
        in torchtext2.nn.MultiheadAttentionContainer.
    ...
    def forward(
        ...
        Examples::
            >>> import torch
            >>> from torchtext2.nn import InProjContainer
            >>> embed_dim, bsz = 10, 64
            >>> in_proj_container = InProjContainer(torch.nn.Linear(embed_dim, embed_dim),
                                                    torch.nn.Linear(embed_dim, embed_dim),
                                                    torch.nn.Linear(embed_dim, embed_dim))

...
from torchtext2.models.t5.model import PAST_KEY_VALUES_TYPE, SEQ_2_SEQ_OUTPUTS_TYPE
...
@dataclass
class T5Bundle:
    """T5Bundle(_config: torchtext2.prototype.models.T5Conf, _path: Optional[str] = None, transform: Optional[Callable] = None)

    Example - Pretrained base t5 encoder
        >>> import torch, torchtext2
        >>> t5_encoder_base = torchtext2.prototype.models.T5_BASE_ENCODER
    ...
    Example - Pretrained base t5 model
        >>> import torch, torchtext2
        >>> t5_base = torchtext2.prototype.models.T5_BASE
    ...
    Example - Pretrained base t5 model for generation
        ...
        >>> t5_base_generation = torchtext2.prototype.models.T5_BASE_GENERATION
    ...
    Example - User-specified configuration and checkpoint
        >>> from torchtext2.prototype.models import T5Conf, T5Bundle
...
ENCODER_DOC = """
    ...
    Please refer to :func:`torchtext2.prototype.models.T5Bundle` for the usage.
"""
...
FLAN_ENCODER_DOC = """
    ...
    Please refer to :func:`torchtext2.models.T5Bundle` for the usage.
"""

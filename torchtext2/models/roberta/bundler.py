...
from torchtext2._download_hooks import load_state_dict_from_url
...
@dataclass
class RobertaBundle:
    """RobertaBundle(_params: torchtext2.models.RobertaEncoderParams, _path: Optional[str] = None, _head: Optional[torch.nn.Module] = None, transform: Optional[Callable] = None)

    Example - Pretrained base xlmr encoder
        >>> import torch, torchtext2
        >>> from torchtext2.functional import to_tensor
        >>> xlmr_base = torchtext2.models.XLMR_BASE_ENCODER
    ...
    Example - Pretrained large xlmr encoder attached to un-initialized classification head
        >>> import torch, torchtext2
        >>> from torchtext2.models import RobertaClassificationHead
        >>> from torchtext2.functional import to_tensor
        >>> xlmr_large = torchtext2.models.XLMR_LARGE_ENCODER
        >>> classifier_head = torchtext2.models.RobertaClassificationHead(num_classes=2, input_dim = 1024)
    ...
    Example - User-specified configuration and checkpoint
        >>> from torchtext2.models import RobertaEncoderConf, RobertaBundle, RobertaClassificationHead
    ...
    def get_model(
        ...
        *,
        ...
        r"""get_model(head: Optional[torch.nn.Module] = None, load_weights: bool = True, freeze_encoder: bool = False, *, dl_kwargs=None) -> torchtext2.models.RobertaModel
...
XLMR_BASE_ENCODER.__doc__ = """
    ...
    Please refer to :func:`torchtext2.models.RobertaBundle` for the usage.
    """

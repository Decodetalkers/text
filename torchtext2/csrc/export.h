...
//
// In the context of torchtext2, the logic is simpler at the moment.
//
// The torchtext2 custom operations are implemented in
// `torchtext2/lib/libtorchtext2.[so|pyd]`. Some symbols are referred from
// `torchtext2._torchtext2`.
//
// In Windows, default visibility of dynamically library are hidden, while in
// Linux/macOS, they are visible.
//
// At the moment we do not expect torchtext2 libraries to be built/linked

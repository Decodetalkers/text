...
#include <torchtext2/csrc/bert_tokenizer.h> // @manual
#include <torchtext2/csrc/clip_tokenizer.h> // @manual
#include <torchtext2/csrc/gpt2_bpe_tokenizer.h> // @manual
#include <torchtext2/csrc/regex.h>
#include <torchtext2/csrc/regex_tokenizer.h> // @manual
#include <torchtext2/csrc/sentencepiece.h> // @manual
#include <torchtext2/csrc/vectors.h> // @manual
#include <torchtext2/csrc/vocab.h> // @manual

namespace torchtext2 {

TORCH_LIBRARY_FRAGMENT(torchtext2, m) {
  ...
  m.def("torchtext2::generate_sp_model", &generate_sp_model);
  m.def("torchtext2::load_sp_model", &load_sp_model);
  m.def("torchtext2::load_sp_model_string", &load_sp_model_string);
  m.def("torchtext2::gpt2_bpe_pre_tokenizer", &gpt2_bpe_pre_tokenizer);
  m.def(
      "torchtext2::set_utf8_decoding_ignore",

...
def build_vocab_from_text_file(
    ...
    Returns:
        torchtext2.vocab.Vocab: a `Vocab` object.
    Examples:
        >>> from torchtext2.experimental.vocab_factory import build_vocab_from_text_file
...
def load_vocab_from_file(file_path: str, min_freq: int = 1, num_cpus: int = 4) -> Vocab:
    ...
    Examples:
        >>> from torchtext2.vocab import load_vocab_from_file

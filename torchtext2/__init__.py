...
_TORCHTEXT_DEPRECATION_MSG = (
    ...
    "`import torchtext2; torchtext2.disable_torchtext2_deprecation_warning()`"
)

def disable_torchtext2_deprecation_warning():
    global _WARN
    _WARN = False

# the following import has to happen first in order to load the torchtext2 C++ library
from torchtext2 import _extension  # noqa: F401

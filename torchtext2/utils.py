...
from torchtext2 import _CACHE_DIR
...
def download_from_url(url, path=None, root=".data", overwrite=False, hash_value=None, hash_type="sha256"):
    ...
    Examples:
        ...
        >>> torchtext2.utils.download_from_url(url)
        >>> url = 'http://www.quest.dcs.shef.ac.uk/wmt16_files_mmt/validation.tar.gz'
        >>> torchtext2.utils.download_from_url(url)
...
def extract_archive(from_path, to_path=None, overwrite=False):
    ...
    Examples:
        ...
        >>> to_path = './'
        >>> torchtext2.utils.download_from_url(url, from_path)
        >>> torchtext2.utils.extract_archive(from_path, to_path)
...
def get_asset_local_path(asset_path: str, overwrite=False) -> str:
    ...
    Examples:
        ...
        >>> torchtext2.utils.get_asset_local_path(url)
        >>> '.data/file.txt'
        >>> torchtext2.utils.get_asset_local_path('/home/user/file.txt')
        >>> '/home/user/file.txt'
    """
